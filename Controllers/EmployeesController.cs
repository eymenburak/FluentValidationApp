...
namespace FluentValidationApp.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(FluentAppDbContext context, IValidator<Employee> employeeValidator)
        {
            _context = context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Email,Age")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
